...
/**
 * Страница настроек с закреплённой шапкой-пилюлей [SettingsHeaderCard]:
 * парит ПОВЕРХ контента без фоновой полосы. Контент занимает весь экран и уходит под пилюлю, поэтому
