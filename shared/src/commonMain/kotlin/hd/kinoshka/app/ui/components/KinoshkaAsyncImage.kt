...
expect fun KinoshkaAsyncImage(
    ...
    /** Когда true — слоты загрузки/ошибки прозрачные (без шиммера и иконки):
     *  для верхнего слоя двухслойного кроссфейда, под которым уже лежит
     *  закэшированное превью (см. ProfileEditorCoverBackdrop). */
