...
enum class FilterPreset(
  ...
  NONE(
    displayName = "Выкл",
    description = "Настройки по умолчанию без изменений",
    brightness = 0,
    saturation = 0,
    contrast = 0,
    gamma = 0,
  ...
  VIVID(
    displayName = "Яркий",
    description = "Усиленные цвета с чёткими деталями",
    brightness = 5,
    saturation = 25,
    contrast = 15,
    gamma = 0,
  ...
  WARM_TONE(
    displayName = "Тёплый",
    description = "Тёплые цвета с золотистым оттенком",
    brightness = 5,
    saturation = 10,
    contrast = 5,
    gamma = 5,
  ...
  COOL_TONE(
    ...
    description = "Холодные цвета с синим оттенком",
    brightness = 0,
    saturation = 5,
    contrast = 10,
    gamma = 0,
  ...
  SOFT_PASTEL(
    displayName = "Пастель",
    description = "Мягкие приглушённые цвета",
    brightness = 10,
    saturation = -15,
    contrast = -10,
    gamma = 5,
  ...
  CINEMATIC(
    displayName = "Кино",
    description = "Кинематографичная цветокоррекция",
    brightness = -5,
    saturation = -10,
    contrast = 20,
    gamma = -5,
  ...
  DRAMATIC(
    displayName = "Драма",
    description = "Контрастный драматичный вид",
    brightness = -10,
    saturation = 15,
    contrast = 30,
    gamma = -10,
  ...
  NIGHT_MODE(
    displayName = "Ночной",
    description = "Пониженная яркость для тёмных помещений",
    brightness = -20,
    saturation = -5,
    contrast = 5,
    gamma = -10,
  ...
  NOSTALGIC(
    displayName = "Ностальгия",
    description = "Винтажный вид старой плёнки",
    brightness = 5,
    saturation = -20,
    contrast = 10,
    gamma = 0,
  ...
  GHIBLI_STYLE(
    displayName = "Гибли",
    description = "Мягкие мечтательные цвета аниме",
    brightness = 8,
    saturation = 15,
    contrast = -5,
    gamma = 5,
  ...
  DEEP_BLACK(
    displayName = "Глубокий черный",
    description = "Усиленный чёрный для OLED-экранов",
    brightness = -15,
    saturation = 5,
    contrast = 25,
    gamma = -15,
