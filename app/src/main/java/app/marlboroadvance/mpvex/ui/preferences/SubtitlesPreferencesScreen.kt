    ...
    Scaffold(
      ...
      ProvidePreferenceLocals {
        ...
        LazyColumn(
          ...
          item {
            PreferenceSectionHeader(title = "Поиск субтитров")
          }
          ...
          item {
            PreferenceCard {
              ...
              MultiChoicePreference(
                title = { Text("Источники субтитров") },
                summary = {
              ...
              Column(modifier = Modifier.fillMaxWidth()) {
                Row(
                  ...
                  Text(
                    text = "Дополнительные фильтры поиска",
                ...
                if (showAdvanced) {
                  Column(modifier = Modifier.padding(horizontal = 16.dp)) {
                    SwitchPreference(
                      ...
                      title = { Text("Для слабослышащих") },
                      summary = { Text("Показывать только субтитры, оптимизированные для слабослышащих") }
                    )

                    PreferenceDivider()

                    MultiChoicePreference(
                      title = { Text("Предпочитаемые форматы") },
                      summary = {
                    ...
                    MultiChoicePreference(
                      title = { Text("Предпочитаемые кодировки") },
                      summary = {
              ...
              Row(
                ...
                Text(
                  text = "Поиск субтитров предоставлен",
                  style = MaterialTheme.typography.bodySmall,
                  color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                Text(
